...
/*
03) Copy your previous package "hw3Q3Inheritance01" and rename it to "hw4Q3Inheritance02" inside your 
HW project and execute the remaining. Read the question very carefully. 
h) Create another class "BullDog". 
Implement a method inside the class -- bullDogInfo and System.out.println("This method is from BullDog Class"). 
